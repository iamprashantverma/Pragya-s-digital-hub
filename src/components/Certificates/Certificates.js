  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={buttonContainerStyle}>
        ...
        {/* New Certificates */}
        <Button variant="secondary" href="https://www.hackerrank.com/certificates/08dfbedf7580" target="_blank" style={buttonStyle}>
          🏆 HackerRank Problem Solving Certificate
        </Button>
        <Button variant="danger" href="https://cutshort.io/certificate/111810" target="_blank" style={buttonStyle}>
          📑 Cutshort Skill Certificate
        </Button>
        <Button variant="dark" href="https://drive.google.com/file/d/1s4vRIJB4a07aU601w5hhmiGUNc8K-pKM/view?usp=drive_link" target="_blank" style={buttonStyle}>
